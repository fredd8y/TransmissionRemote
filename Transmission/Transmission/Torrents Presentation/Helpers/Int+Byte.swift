...
extension Int {
	...
	var speed: String {
		...
		case 0 ..< 1_000: // Byte
			return "\(self) B/s"
		case 1_001 ..< 1_000_000: // Kbyte
			return "\((Double(self) / Double(1_000)).round() ?? "-") KB/s"
		case 1_000_001 ..< 1_000_000_000: // Mbyte
			return "\((Double(self) / Double(1_000_000)).round() ?? "-") MB/s"
		case 1_000_000_001 ..< 1_000_000_000_000: // Gbyte
			return "\((Double(self) / Double(1_000_000_000)).round() ?? "-") GB/s"
		case 1_000_000_000_001 ..< 1_000_000_000_000_000: // Tbyte
			return "\((Double(self) / Double(1_000_000_000_000)).round() ?? "-") TB/s"
		default:
			return "-"
		}
	}
